...
def object_detection(PATH_TO_IMAGE):
    ...
    PATH_TO_CKPT = os.path.join('/fs-object-detection/dhl/dhl-classify-savedmodel-Experiment1/','frozen_inference_graph.pb')

    # Path to label map file
    PATH_TO_LABELS = os.path.join('/fs-object-detection/dhl/Experiments1','label_map.pbtxt')
