...
class DetectionEvaluator(object):
  ...
  def __init__(self, categories):
    ...
    """
    #print('Inside DetectionEvaluator.__init__')
  ...
  def add_single_ground_truth_image_info(self, image_id, groundtruth_dict):
    ...
    Args:
      ...
      groundtruth_dict: A dictionary of groundtruth numpy arrays required
        for evaluations.
    """
    #print('Inside DetectionEvaluator.add_gt')
    pass
  ...
  def add_single_detected_image_info(self, image_id, detections_dict):
    ...
    Args:
      ...
      detections_dict: A dictionary of detection numpy arrays required
        for evaluation.
    """
    #print('Inside DetectionEvaluator.add_detected')
    pass

  @abstractmethod
  def evaluate(self):
    """Evaluates detections and returns a dictionary of metrics."""
    #print('Inside DetectionEvaluator.evaluate')
    pass
...
class ObjectDetectionEvaluator(DetectionEvaluator):
  ...
  def __init__(self,
    ...
    Args:
      ...
      use_weighted_mean_ap: (optional) boolean which determines if the mean
        ...
        of all classes.
    """
    #print('Inside ObjectDetectionEvaluator.__init__')
  ...
  def add_single_ground_truth_image_info(self, image_id, groundtruth_dict):
    ...
    """
    #print('Inside ObjectDetectionEvaluator.add_gt')
    ...
    Args:
      ...
      detections_dict: A dictionary containing -
        ...
        standard_fields.DetectionResultFields.detection_classes: integer numpy
          ...
          the boxes.
    """
    #print('Inside ObjectDetectionEvaluator.add_detected')
  ...
  def evaluate(self):
    ...
    """
    #print('Inside ObjectDetectionEvaluator.evaluate')
  ...
  def clear(self):
    """Clears the state to prepare for a fresh evaluation."""
    #print('Inside ObjectDetectionEvaluator.clear')
    self._evaluation = ObjectDetectionEvaluation(
        self._num_classes,
        matching_iou_threshold=self._matching_iou_threshold,
        use_weighted_mean_ap=self._use_weighted_mean_ap,
...
class PascalDetectionEvaluator(ObjectDetectionEvaluator):
  ...
  def __init__(self, categories, matching_iou_threshold=0.5):
    #print('Inside PascalDetectionEvaluator.__init__')
...
class WeightedPascalDetectionEvaluator(ObjectDetectionEvaluator):
  ...
  def __init__(self, categories, matching_iou_threshold=0.5):
    #print('Inside WeightedPascalDetectionEvaluator.__init__')
...
class OpenImagesDetectionEvaluator(ObjectDetectionEvaluator):
  ...
  def __init__(self,
    ...
    """
    #print('Inside OpenImagesDetectionEvaluator.__init__')
  ...
  def add_single_ground_truth_image_info(self, image_id, groundtruth_dict):
    ...
    Raises:
      ValueError: On adding groundtruth for an image more than once.
    """
    #print('Inside OpenImagesDetectionEvaluator.add_gt')
    if image_id in self._image_ids:
      raise ValueError('Image with id {} already added.'.format(image_id))
...
class ObjectDetectionEvaluation(object):
  ...
  def __init__(self,
               ...
               use_weighted_mean_ap=False,
               label_id_offset=0):
    #print('Inside ObjectDetectionEvaluation.__init__')
  ...
  def clear_detections(self):
    #print('Inside ObjectDetectionEvaluation.clear')
    self.detection_keys = {}
    self.scores_per_class = [[] for _ in range(self.num_class)]
    self.tp_fp_labels_per_class = [[] for _ in range(self.num_class)]
    self.num_images_correctly_detected_per_class = np.zeros(self.num_class)
  ...
  def add_single_ground_truth_image_info(self,
    ...
    """
    #print('Inside ObjectDetectionEvaluation.add_gt')
  ...
  def add_single_detected_image_info(self, image_key, detected_boxes,
    ...
    Raises:
      ValueError: if the number of boxes, scores and class labels differ in
        length.
    """
    #print('Inside ObjectDetectionEvaluation.add_detected')
  ...
  def evaluate(self):
    ...
    """
    #print('Inside ObjectDetectionEvaluation.evaluate')
